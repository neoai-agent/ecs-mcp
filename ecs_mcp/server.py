...
class ECSMCPServer:
    ...
    async def get_ecs_target_group_response_time(self, service_name: str, period_minutes: int = 15):
    ...
    async def get_ecs_target_group_request_metrics(self, service_name: str, period_minutes: int = 15):
